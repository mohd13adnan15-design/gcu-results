...
export function UnifiedLogin() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      clearStudentSession();
      toast.error(
        "This account is not linked to a student record or staff portal. Check your email or contact the Admin office.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md card-elevated rounded-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-md border border-border bg-cream px-3 py-2 outline-none focus:ring-2 focus:ring-primary pr-10"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <p className="mt-6 text-xs text-muted-foreground leading-relaxed">
            Access your academic records, track your progress, and stay updated with ease.{" "}
            <Link to="/signup" className="font-medium text-primary hover:opacity-80">
              New here? <span className="font-bold text-sm">Sign up today</span>
            </Link>
          </p>
        </div>
      </div>
