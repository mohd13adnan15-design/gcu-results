...
export function StudentMarksCardPage() {
  return <StudentLayout title="Marksheet">{() => <MarksCard />}</StudentLayout>;
}
      ...
      <div className="space-y-6">
        ...
        <div className="card-elevated mx-auto max-w-lg rounded-2xl p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Complete fee clearance, submit your verification request, and wait for Admin 1 and Admin
            2 approval. You can track progress on the certificate flow page.
          </p>
