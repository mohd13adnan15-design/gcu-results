        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 rounded-md border border-border bg-cream px-6 py-3 text-base font-medium text-primary hover:bg-secondary"
              >
                Sign Up
              </Link>
            </div>
        ...
        <div className="card-elevated flex flex-col items-start gap-6 rounded-2xl p-8 md:flex-row md:items-center md:justify-between md:p-10">
          <div className="max-w-xl">
            ...
            <p className="mt-2 text-base text-muted-foreground">
              Sign in with your university credentials to unlock your academic achievements.
            </p>
          </div>
