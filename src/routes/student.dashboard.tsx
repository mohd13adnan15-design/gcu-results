    ...
    <div className="space-y-8">
      ...
      <section className="card-elevated rounded-2xl p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {eligible
                ...
                : certificateEntryUnlocked
                  ? "Fees are clear — open the certificate page to start the process (one tap) and track Admin 2 / Admin 1 review."
          ...
          >
            {eligible ? "Certificate & download" : "Generate certificate"}
          </button>
        </div>
      </section>
    </div>
